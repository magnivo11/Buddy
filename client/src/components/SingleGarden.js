  ...
  <div  style={{fontFamily: "Open Sans"}}>
    <meta name="viewport" content="width=device-width, initial-scale=1"></meta>
      <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css"></link>
        ...
        <section id="specials" className="specials" style={mobile?{ backgroundColor: 'rgba(117, 128, 107,0.85)', marginTop: '0%', marginLeft: '9%', marginRight: '9%' }:{ backgroundColor: 'rgba(117, 128, 107,0.85)', marginTop: '-70%', marginLeft: '9%', marginRight: '9%' }}>
