                  ...
                  {(!plant.sensorID) ? <div>
                    ...
                    <div>
                      <div style={{ display: 'flex', flexDirection: 'raw' }} class='header'>
                        <button type="button"  style= {!mobileMode?{ width: '66px', color: "grey", backgroundColor: 'rgba(52, 52, 52, 0.8)',fontSize:"8px" }:{ width: '167px', color: "grey", backgroundColor: 'rgba(52, 52, 52, 0.8)' }} value='Soil Moisture' onClick={changeChartData} class="btn btn-default"> Soil Moisture</button>
                        <button type="button" style={!mobileMode?{ width: '66px', color: "grey", backgroundColor: 'rgba(52, 52, 52, 0.8)',fontSize:"8px" }:{ width: '167px', color: "grey", backgroundColor: 'rgba(52, 52, 52, 0.8)' }} value='Temperature' onClick={changeChartData} class="btn btn-default"> Temperature</button>
                        <button type="button" style={!mobileMode?{ width: '66px', color: "grey", backgroundColor: 'rgba(52, 52, 52, 0.8)',fontSize:"8px" }:{ width: '167px', color: "grey", backgroundColor: 'rgba(52, 52, 52, 0.8)' }} value='Sun Exposure' onClick={changeChartData} class="btn btn-default"> Sun Exposure</button>
                      </div>
